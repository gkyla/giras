  ...
  >
    ...
    <div id="history" class="">
      ...
      <div
        ref="aboutMe"
        id="aboutme"
        class="w-full min-h-[600px] flex justify-center py-16 p-10 mb-16"
      >
        <div
      ...
      <div
        id="myworks"
        class="container mx-auto max-w-screen-xl flex flex-col items-center justify-center my-20 px-2"
      >
      ...
      <div
        ref="socials"
        id="socials"
        class="flex flex-col bg-slate-50 items-center justify-center relative min-h-[550px]"
      >
        <div class="p-10 z-20">
          <div
